...
/**
 * Implements an importer from a CSV file.
 */
...
if ($f->submit ()) {
	if (move_uploaded_file ($_FILES['import_file']['tmp_name'], 'cache/organizations_csv_import.csv')) {
		...
		if (($f = fopen ($file, 'r')) !== false) {
			...
			echo $tpl->render ('organizations/import2', array (
				'headers' => $headers,
				'samples' => $samples
			));
			return;
...
echo $tpl->render ('organizations/import', $o);
